...
/bin/bash "/Applications/Utilities/Maintenance.app/Contents/Resources/MBBR_check.sh" &
/bin/bash "/Applications/Utilities/Maintenance.app/Contents/Resources/purge_cache.sh" &
/bin/bash "/Applications/Utilities/Maintenance.app/Contents/Resources/clear_browser_caches.sh" &
/bin/bash "/Applications/Utilities/Maintenance.app/Contents/Resources/uptime.sh"
