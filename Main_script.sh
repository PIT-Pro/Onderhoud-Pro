...
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/main/Resources/MBBR_check.sh)" 1> /Users/Public/maintenance_log.txt
echo "Purging caches.." | tee /Users/Public/maintenance_log.txt
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/main/Resources/purge_cache.sh)" 1> /Users/Public/maintenance_log.txt
echo "Clearing browser caches.." | tee /Users/Public/maintenance_log.txt
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/main/Resources/clear_browser_caches.sh)" 1> /Users/Public/maintenance_log.txt
echo "Checking uptime.." | tee /Users/Public/maintenance_log.txt
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/main/Resources/uptime.sh)" 1> /Users/Public/maintenance_log.txt
