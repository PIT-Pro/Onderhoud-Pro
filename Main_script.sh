...
#
echo "Checking MBBR.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/Resources/MBBR_check.sh)" 1> /dev/null
echo "Purging caches.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/Resources/purge_cache.sh)" 1> /dev/null
echo "Clearing browser caches.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/Resources/clear_browser_caches.sh)" 1> /dev/null
echo "Checking uptime.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Maintenance/Resources/uptime.sh)" 1> /dev/null
